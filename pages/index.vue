                            ...
                            <div class="container px-5">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-6" data-aos="fade-up">
                                        <div class="badge rounded-pill bg-primary-soft text-primary badge-marketing mb-3">OPPS Final Rule and No Surprises Act</div>
                                        <h1 class="page-header-ui-title">Hospital Price Transparency & Good Faith Estimates</h1>
                                        <p class="page-header-ui-text mb-5">
                                            You're already spread thin, and Hospital compliance takes too much time, energy, money, and resources. However, there's good news -
                                            <strong>we can do it for you</strong>
                                            .
                                        </p>
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <a class="btn btn-lg btn-primary-soft text-primary fw-500" href="https://docs.startbootstrap.com/sb-ui-kit-pro/quickstart" target="_blank">Learn More</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 d-none d-lg-block" data-aos="fade-up" data-aos-delay="100"><img class="img-fluid" src="assets/img/claraprice/data-people.svg" alt="Hospital Compliance Made Easy" /></div>
                                </div>
                            </div>
                        </div>
